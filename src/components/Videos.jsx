  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <div className='md:flex gap-10'>
        ...
        <div className='border-2 border-solid rounded-2xl flex flex-col overflow-y-scroll h-[650px] p-4 gap-4 w-[350px]'>
          {videoData["standard" + number].map((video) => (
            <div
              key={video.id}
              onClick={() => setSelectedVideo(video)}
              className={`flex flex-col border border-gray-200 rounded-lg p-3 cursor-pointer transition-all hover:shadow-md ${
        ...
        {/* Player Container */}
        <div className='flex flex-col overflow-hidden rounded-2xl shadow-lg w-[800px]'>
